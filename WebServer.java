...
public class WebServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        server.createContext("/greet", new GreetingHandler());
    ...
    static class StaticHandler implements HttpHandler {
        ...
        private void serveDirectory(File dir, HttpExchange t) throws IOException {
            ...
            File result = new File(dir, "result.html");
//SERVER CODE SERVES RESUTS.HTML FILE AFTER A SEARCH IS CONDUCTED. 
            if (index.exists()) {
                log("--> found index");
                Search search = new Search(result, t);
                if (search.doSearch()) serveFile(result, t);
                else serveFile(index, t);
                return;
            }
//END
            Headers headers = t.getResponseHeaders();
